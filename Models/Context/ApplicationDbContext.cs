...
namespace stocktakingApi.Models.Context
{
    public class ApplicationDbContext : DbContext
    {
        ...
        new Staff { StaffId = 3, StaffName = "Charles Schwab", StaffDescription = "Charles serves as the technical director and business advisor. He has served  the business for more than 6 years", StaffRole = "Business Psychologist" },
