...
namespace stocktakingApi.Models.Context
{
    public class ApplicationDbContext : DbContext
    {
        ...
        new StockItem { Description = "LaserJet Printers D426S with portable print head ", Name = "LaserJet Printers", StockItemId = 1,StaffId =1,StockAmount=4},
        new StockItem { Description = "Lenovo T430 model 2023 s/n= 2638JK23893MOS", Name = "Lenovo laptop", StockItemId = 2, StaffId = 4, StockAmount = 87 },
        new StockItem { Description = "Dell D39 model 2022 s/n = P537X3672", Name = "Dell Laptop ", StockItemId = 3, StaffId = 1, StockAmount = 27 },
        new StockItem { Description = "Kyocera Printers with mini paper cabins s/n Up673Jd", Name = "Kyocera Printers", StockItemId = 4, StaffId = 1, StockAmount = 6 });
