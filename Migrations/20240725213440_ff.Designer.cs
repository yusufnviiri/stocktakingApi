...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("stocktakingApi.Models.Staff", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StaffId = 3,
                            StaffDescription = "Charles serves as the technical director and business advisor. He has served  the business for more than 6 years",
                            StaffName = "Charles Schwab",
            ...
            modelBuilder.Entity("stocktakingApi.Models.StaffTask", b =>
                {
            ...
            modelBuilder.Entity("stocktakingApi.Models.StaffTask", b =>
                {
                    b.HasOne("stocktakingApi.Models.Staff", "staff")
                        .WithMany()
                        .HasForeignKey("StaffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("stocktakingApi.Models.StockItem", "stockItem")
                        .WithMany()
